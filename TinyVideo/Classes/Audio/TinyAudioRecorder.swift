...
public class TinyAudioRecorder:AudioProducerProtocol{
    ...
    public init(audioStreamDescription:AudioStreamBasicDescription = TinyAudioRecorder.PCMFloatStream) throws {
        self.threadQueue = DispatchQueue(label: "TinyAudioRecorder.threadQueue")
